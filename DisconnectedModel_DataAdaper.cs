...
////1- data adapter methods:
////fill --> data transfer from data source (db) to dataset
////update --> data transfer (update) from dataset to data source (db)

////2- data adapter commands
...
namespace disconnectedModel
{
    class program
    {
        static void Main()
        {
            ...
            //adding parameters because queries used above are parameterized queries
            da.UpdateCommand.Parameters.Add("@Name", SqlDbType.NVarChar, 50, "name"); //adding parameters
            da.InsertCommand.Parameters.Add("@Name", SqlDbType.NVarChar, 50, "name"); //adding parameters
            da.InsertCommand.Parameters.Add("@passworddd", SqlDbType.NVarChar, 50, "password"); //adding parameters
            SqlParameter p0 = da.UpdateCommand.Parameters.Add("@ID", SqlDbType.Int); //adding parameters
            SqlParameter p = da.DeleteCommand.Parameters.Add("@ID", SqlDbType.Int); //adding parameters
